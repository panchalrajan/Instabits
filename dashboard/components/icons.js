...
IconLibrary.icons = {
    ...
    'user-x': `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    'lightning': `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        <path d="M13 2L3 14H12L11 22L21 10H12L13 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`,

    'close': `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
